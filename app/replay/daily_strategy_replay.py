        ...
        for symbol in symbols:
            ...
            if details_root is not None:
                ...
                detail = {
                    ...
                    "open_noise_abs": getattr(plan, "open_noise_abs", None),
                    "open_noise_bps": getattr(plan, "open_noise_bps", None),
                    "open_noise_atr": getattr(plan, "open_noise_atr", None),
                    "open_noise_stop_ratio": getattr(plan, "open_noise_stop_ratio", None),
                    "stop_to_open_noise_ratio": getattr(plan, "stop_to_open_noise_ratio", None),
                    "open_noise_window_minutes": getattr(plan, "open_noise_window_minutes", None),
